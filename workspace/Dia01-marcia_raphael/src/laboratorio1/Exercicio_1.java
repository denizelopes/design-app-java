...
public class Exercicio_1 {
	...
	public static List<Produto> ordenaListaProdutosPorNome() {
		List<Produto> produtos = obtemListaProdutos();
		produtos.sort((c1, c2) -> c1.getNome().compareTo(c2.getNome()));
		return produtos;
	}

	public static List<Produto> obtemListaProdutos() {
		List<Produto> listaProdutos = Arrays.asList(new Produto("Samsung J5 Prime", 899.00),
				new Produto("Xiaomi Mi 9", 2299.00), new Produto("Notebook Dell Inspiron 5566 A50P", 2999.00),
				new Produto("Impressora LexMark XXJ25", 799.00), new Produto("TV LG 42 Polegadas", 1899.00),
