...
public class Exemplo_1 {
	...
	public static void main(String[] args) {
		...
		String resultado = String.format("Média de %d notas = %d", listaNotas.size(),
		...
		listaNotas.forEach((item) -> System.out.println(
				"O valor da raiz quadradada do numero " + item + " é " + calculadora.calculaRaizQuadrada(item)));
		

		listaNotas.forEach((item) -> System.out.println(
				"O numero " + item + " elevado ao cubo é " + calculadora.elevarAoCubo(item)));
